...
5. **Interfaccia Grafica e Layout**:
   ...
   - **Pallino Controllo**: L'indicatore di controllo mensile sulla card è giallo piatto (#ffcc00) con contorno bianco solido di 2px (classe .monthly-check-dot in style.css), per essere visibile anche sullo sfondo verde dello stato "disponibile" (#008000).
